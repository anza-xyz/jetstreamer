...
- Tag/version: `v1.0.14`
- Commit: `8631be42ac29a062b5e26a85fc2f4c94af042afd`
- Imported subtree: `runtime/`
- Upstream `runtime/` Git tree: `f9e927434f469754ac1205bf66614720b98dc71b`
...
```text
git rev-parse v1.0.14^{} v1.0.14^{}:runtime v1.0.14^{}:LICENSE
```
