...
const BACKEND_ID: &str = "solana-v1.6.15";
const SOLANA_TAG: &str = "v1.6.15";
const SOLANA_COMMIT: &str = "5c2dab8055e8162386fcac313b6547f223fd386c";
    ...
    for write in writes {
        if write.data.len() as u64 > MAX_PERMITTED_DATA_LENGTH {
            return Err(io::Error::new(
                ...
                "historical account write exceeds v1.6.15's maximum account-data length",
            ));
        }
...
mod tests {
    ...
    fn handshake_is_explicitly_unqualified_candidate() {
        ...
        assert_eq!(handshake.backend_id, "solana-v1.6.15");
        assert_eq!(
            handshake.solana_commit,
            "5c2dab8055e8162386fcac313b6547f223fd386c"
        );
        assert_eq!(
