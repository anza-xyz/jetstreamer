//! Fast, exact v1.5.19 Proof-of-History hashing.
//!
...
//!
//! Solana v1.5.19 retained v1.0.7's `entry::next_hash` wire semantics, so this
...
/// Exact equivalent of v1.5.19 `ledger::entry::next_hash` after the caller has
