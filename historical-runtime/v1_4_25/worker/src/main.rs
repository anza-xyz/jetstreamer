...
const BACKEND_ID: &str = "solana-v1.4.25";
const SOLANA_TAG: &str = "v1.4.25";
const SOLANA_COMMIT: &str = "893cc7647248a3536fb6e6d0b5e51c71446b862d";
    ...
    for write in writes {
        if write.data.len() as u64 > MAX_PERMITTED_DATA_LENGTH {
            return Err(io::Error::new(
                ...
                "historical account write exceeds v1.4.25's maximum account-data length",
            ));
        }
...
mod tests {
    ...
    fn handshake_is_explicitly_unqualified_candidate() {
        ...
        assert_eq!(handshake.backend_id, "solana-v1.4.25");
        assert_eq!(
            handshake.solana_commit,
            "893cc7647248a3536fb6e6d0b5e51c71446b862d"
        );
        assert_eq!(
