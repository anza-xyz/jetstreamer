...
const BACKEND_ID: &str = "solana-v1.0.7";
const SOLANA_TAG: &str = "v1.0.7";
const SOLANA_COMMIT: &str = "57abc370fa39e42e8fb84145a30395ddcf891692";
    ...
    for write in writes {
        if write.data.len() as u64 > MAX_PERMITTED_DATA_LENGTH {
            return Err(io::Error::new(
                ...
                "historical account write exceeds v1.0.7's maximum account-data length",
            ));
        }
...
mod tests {
    ...
    #[test]
    fn account_write_above_v107_limit_is_rejected_before_output() {
        let mut entry = processed_entry(0);
