//! Fast, exact pre-CPI v1.2.24 Proof-of-History hashing.
//!
...
//!
//! Solana v1.2.24 retained v1.0.7's `entry::next_hash` wire semantics, so this
...
/// Exact equivalent of v1.2.24 `ledger::entry::next_hash` after the caller has
