...
// This worker is deliberately bounded to the root-checkpoint cohort spanning
// epochs 67 and 68. It uses the v1.2.32 execution tree while reconstructing
// mainnet's serde-skipped activation state at slot 29,371,188. It may
// only be admitted after matching the cohort's independent checkpoints.
const MIN_SUPPORTED_SNAPSHOT_SLOT: u64 = 28_943_975;
