...
const BACKEND_ID: &str = "solana-v1.3.23";
const SOLANA_TAG: &str = "v1.3.23";
const SOLANA_COMMIT: &str = "ab235b8160f1c76e5066eee52d62d976d12f42f1";
    ...
    for write in writes {
        if write.data.len() as u64 > MAX_PERMITTED_DATA_LENGTH {
            return Err(io::Error::new(
                ...
                "historical account write exceeds v1.3.23's maximum account-data length",
            ));
        }
...
mod tests {
    ...
    fn handshake_is_explicitly_unqualified_candidate() {
        ...
        assert_eq!(handshake.backend_id, "solana-v1.3.23");
        assert_eq!(
            handshake.solana_commit,
            "ab235b8160f1c76e5066eee52d62d976d12f42f1"
        );
        assert_eq!(
