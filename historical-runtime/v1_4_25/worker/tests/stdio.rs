...
fn worker_remains_alive_across_framed_requests() -> io::Result<()> {
    // This historical Cargo predates the compile-time CARGO_BIN_EXE_* variable
    // used by newer workspaces. Integration tests live in target/debug/deps;
    ...
    executable.push("jetstreamer-historical-worker-v1-4-25");
