...
const BACKEND_ID: &str = "solana-v1.5.6";
const SOLANA_TAG: &str = "v1.5.6";
const SOLANA_COMMIT: &str = "01e4d0a1e9917701d1a148e1043b0ccf545c27f1";
    ...
    for write in writes {
        if write.data.len() as u64 > MAX_PERMITTED_DATA_LENGTH {
            return Err(io::Error::new(
                ...
                "historical account write exceeds v1.5.6's maximum account-data length",
            ));
        }
...
mod tests {
    ...
    fn handshake_is_explicitly_unqualified_candidate() {
        ...
        assert_eq!(handshake.backend_id, "solana-v1.5.6");
        assert_eq!(
            handshake.solana_commit,
            "01e4d0a1e9917701d1a148e1043b0ccf545c27f1"
        );
        assert_eq!(
