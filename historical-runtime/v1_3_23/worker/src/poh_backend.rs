//! Fast, exact v1.3.23 Proof-of-History hashing.
//!
...
//!
//! Solana v1.3.23 retained v1.0.7's `entry::next_hash` wire semantics, so this
...
/// Exact equivalent of v1.3.23 `ledger::entry::next_hash` after the caller has
