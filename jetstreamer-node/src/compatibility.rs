...
/// The canonical epoch-30 bootstrap reports v1.1.14 and both of its trusted
/// checkpoints report v1.1.15. Those tags have identical runtime source, so
/// the v1.1.15 worker is the narrow exact candidate for the complete epoch.
pub const SOLANA_V1_1_15_CANDIDATE_START_SLOT: Slot = SOLANA_V1_0_23_CANDIDATE_END_SLOT_EXCLUSIVE;
pub const SOLANA_V1_1_15_CANDIDATE_END_SLOT_EXCLUSIVE: Slot = 13_392_000;
...
/// Epochs 101 through 118, ending at the first v1.4 candidate epoch.
pub const SOLANA_V1_3_23_CANDIDATE_END_SLOT_EXCLUSIVE: Slot = 51_408_000;
pub const SOLANA_V1_4_25_CANDIDATE_START_SLOT: Slot = SOLANA_V1_3_23_CANDIDATE_END_SLOT_EXCLUSIVE;
/// Epochs 119 through 147, ending at the first v1.5 candidate epoch.
...
pub const SOLANA_V1_5_19_CANDIDATE_END_SLOT_EXCLUSIVE: Slot = 75_168_000;
pub const SOLANA_V1_6_15_CANDIDATE_START_SLOT: Slot = SOLANA_V1_5_19_CANDIDATE_END_SLOT_EXCLUSIVE;
...
pub const SOLANA_V1_1_15_REVISION: &str = "2cdd3f835f00ca531af7141459d657f0ea60a946";
pub const SOLANA_V1_1_23_REVISION: &str = "263fc25992ebae85e7ba2f176e9a066449489c3e";
pub const SOLANA_V1_2_24_EPOCH67_PRE_CPI_REVISION: &str =
    "14bc62398944d6270698506d468cbeddc8513ccd";
pub const SOLANA_V1_2_32_EPOCH68_TRANSITION_REVISION: &str =
...
pub enum RuntimeBackend {
    ...
    SolanaV1_0_24,
    /// Exact v1.1.15 runtime, behaviorally identical to v1.1.14 and bounded
    /// to checkpoint-gated epoch 30.
    SolanaV1_1_15,
    /// Exact terminal v1.1 patch used only in the checkpoint-gated diagnostic
    /// envelope for epochs 31 through 60.
    SolanaV1_1_23,
    /// Exact v1.2.24 execution with CPI held in the canonical disabled state,
    /// bounded to the pre-transition portion of epoch 67.
    SolanaV1_2_24Epoch67PreCpi,
    /// Exact v1.2.32 execution with mainnet's CPI and vote-timestamp state
    /// transition reconstructed at slot 29,371,188, bounded to epochs 67–68.
    SolanaV1_2_32Epoch68Transition,
    /// Exact terminal v1.2 patch used only in the checkpoint-gated diagnostic
    /// envelopes surrounding epochs 67 and 68.
    SolanaV1_2_32,
    ...
    /// checkpoint-gated diagnostic envelope for epochs 101 through 118.
    SolanaV1_3_23,
    /// Exact terminal v1.4 patch used only in the independently
    /// checkpoint-gated diagnostic envelope for epochs 119 through 147.
    SolanaV1_4_25,
...
impl RuntimeDescriptor {
    ...
    fn validate(self) -> Result<(), String> {
        ...
        let expected_loader = match self.backend {
            ...
            | RuntimeBackend::SolanaV1_1_15
            | RuntimeBackend::SolanaV1_1_23
            | RuntimeBackend::SolanaV1_2_24Epoch67PreCpi
...
pub static SOLANA_V1_1_15_RUNTIME: RuntimeDescriptor = RuntimeDescriptor {
    backend: RuntimeBackend::SolanaV1_1_15,
    identity: RuntimeIdentity {
        name: "solana-v1.1.15",
        revision: SOLANA_V1_1_15_REVISION,
        rust_toolchain: "rustc 1.43.0 (4fb7144ed 2020-04-20)",
        target: Some("x86_64-unknown-linux-gnu"),
        genesis_hash: MAINNET_GENESIS_HASH,
    },
    ...
    worker: Some(WorkerExecutable {
        identity: "jetstreamer-historical-worker-v1-1-15",
        environment_override: "JETSTREAMER_HISTORICAL_WORKER_V1_1_15",
        default_manifest_relative_path: "../historical-runtime/v1_1_15/target/release/jetstreamer-historical-worker-v1-1-15",
    }),
};
...
pub static SOLANA_V1_2_32_EPOCH68_TRANSITION_RUNTIME: RuntimeDescriptor = RuntimeDescriptor {
    backend: RuntimeBackend::SolanaV1_2_32Epoch68Transition,
    identity: RuntimeIdentity {
        name: "solana-v1.2.32-mainnet-epoch68-transition",
        revision: SOLANA_V1_2_32_EPOCH68_TRANSITION_REVISION,
        rust_toolchain: "rustc 1.43.0 (4fb7144ed 2020-04-20)",
        target: Some("x86_64-unknown-linux-gnu"),
        genesis_hash: MAINNET_GENESIS_HASH,
    },
    ...
    worker: Some(WorkerExecutable {
        identity: "jetstreamer-historical-worker-v1-2-32-epoch68-transition",
        environment_override: "JETSTREAMER_HISTORICAL_WORKER_V1_2_32_EPOCH68_TRANSITION",
        default_manifest_relative_path: "../historical-runtime/v1_2_32_epoch68_transition/target/release/jetstreamer-historical-worker-v1-2-32-epoch68-transition",
    }),
};

pub static SOLANA_V1_2_24_EPOCH67_PRE_CPI_RUNTIME: RuntimeDescriptor = RuntimeDescriptor {
    backend: RuntimeBackend::SolanaV1_2_24Epoch67PreCpi,
    identity: RuntimeIdentity {
        name: "solana-v1.2.24-mainnet-epoch67-pre-cpi",
        revision: SOLANA_V1_2_24_EPOCH67_PRE_CPI_REVISION,
        rust_toolchain: "rustc 1.43.0 (4fb7144ed 2020-04-20)",
        target: Some("x86_64-unknown-linux-gnu"),
        genesis_hash: MAINNET_GENESIS_HASH,
    },
    ...
    worker: Some(WorkerExecutable {
        identity: "jetstreamer-historical-worker-v1-2-24-epoch67-pre-cpi",
        environment_override: "JETSTREAMER_HISTORICAL_WORKER_V1_2_24_EPOCH67_PRE_CPI",
        default_manifest_relative_path: "../historical-runtime/v1_2_24_epoch67_pre_cpi/target/release/jetstreamer-historical-worker-v1-2-24-epoch67-pre-cpi",
    }),
};
...
pub static SOLANA_V1_3_23_RUNTIME: RuntimeDescriptor = RuntimeDescriptor {
    backend: RuntimeBackend::SolanaV1_3_23,
    identity: RuntimeIdentity {
        name: "solana-v1.3.23",
        revision: SOLANA_V1_3_23_REVISION,
        rust_toolchain: "rustc 1.45.1 (c367798cf 2020-07-26)",
        target: Some("x86_64-unknown-linux-gnu"),
        genesis_hash: MAINNET_GENESIS_HASH,
    },
    ...
    worker: Some(WorkerExecutable {
        identity: "jetstreamer-historical-worker-v1-3-23",
        environment_override: "JETSTREAMER_HISTORICAL_WORKER_V1_3_23",
        default_manifest_relative_path: "../historical-runtime/v1_3_23/target/release/jetstreamer-historical-worker-v1-3-23",
    }),
};
...
pub static SOLANA_V1_4_25_RUNTIME: RuntimeDescriptor = RuntimeDescriptor {
    ...
    identity: RuntimeIdentity {
        name: "solana-v1.4.25",
        revision: SOLANA_V1_4_25_REVISION,
    ...
    worker: Some(WorkerExecutable {
        identity: "jetstreamer-historical-worker-v1-4-25",
        environment_override: "JETSTREAMER_HISTORICAL_WORKER_V1_4_25",
        default_manifest_relative_path: "../historical-runtime/v1_4_25/target/release/jetstreamer-historical-worker-v1-4-25",
    }),
};
...
pub static SOLANA_V1_5_19_RUNTIME: RuntimeDescriptor = RuntimeDescriptor {
    ...
    identity: RuntimeIdentity {
        name: "solana-v1.5.19",
        revision: SOLANA_V1_5_19_REVISION,
    ...
    worker: Some(WorkerExecutable {
        identity: "jetstreamer-historical-worker-v1-5-19",
        environment_override: "JETSTREAMER_HISTORICAL_WORKER_V1_5_19",
        default_manifest_relative_path: "../historical-runtime/v1_5_19/target/release/jetstreamer-historical-worker-v1-5-19",
    }),
};
...
pub static SOLANA_V1_6_15_RUNTIME: RuntimeDescriptor = RuntimeDescriptor {
    ...
    identity: RuntimeIdentity {
        name: "solana-v1.6.15",
        revision: SOLANA_V1_6_15_REVISION,
    ...
    worker: Some(WorkerExecutable {
        identity: "jetstreamer-historical-worker-v1-6-15",
        environment_override: "JETSTREAMER_HISTORICAL_WORKER_V1_6_15",
        default_manifest_relative_path: "../historical-runtime/v1_6_15/target/release/jetstreamer-historical-worker-v1-6-15",
    }),
};
...
pub static RUNTIME_DESCRIPTORS: &[&RuntimeDescriptor] = &[
    ...
    &SOLANA_V1_1_15_RUNTIME,
    &SOLANA_V1_1_23_RUNTIME,
    &SOLANA_V1_2_24_EPOCH67_PRE_CPI_RUNTIME,
...
pub enum TransactionStatusValidation {
    ...
    RuntimeOnly,
    /// Source status frames exist, but their association with transactions is
    /// not trustworthy. The pinned runtime supplies status and fee; canonical
    /// state checkpoints remain the admission gate.
...
pub static RUNTIME_ERAS: &[RuntimeEra] = &[
    ...
    RuntimeEra {
        name: "solana-v1.1.15-epoch-30-differential-candidate",
        start_slot: SOLANA_V1_1_15_CANDIDATE_START_SLOT,
        end_slot_exclusive: Some(SOLANA_V1_1_15_CANDIDATE_END_SLOT_EXCLUSIVE),
        backend: EraBackend::Available(&SOLANA_V1_1_15_RUNTIME),
        admission: AdmissionLevel::Candidate,
    },
    RuntimeEra {
        name: "solana-v1.1.23-epochs-31-60-differential-candidate",
    ...
    RuntimeEra {
        name: "solana-v1.2.32-mainnet-epoch-67-68-transition-candidate",
        start_slot: SOLANA_V1_2_32_EPOCH68_TRANSITION_START_SLOT,
        end_slot_exclusive: Some(SOLANA_V1_2_32_EPOCH68_TRANSITION_END_SLOT_EXCLUSIVE),
        backend: EraBackend::Available(&SOLANA_V1_2_32_EPOCH68_TRANSITION_RUNTIME),
        admission: AdmissionLevel::Candidate,
    },
    RuntimeEra {
        name: "solana-v1.2.32-epochs-69-91-differential-candidate",
        start_slot: SOLANA_V1_2_32_EPOCH68_TRANSITION_END_SLOT_EXCLUSIVE,
    ...
    RuntimeEra {
        name: "solana-v1.3.23-epochs-101-118-differential-candidate",
    ...
    RuntimeEra {
        name: "solana-v1.4.25-epochs-119-147-differential-candidate",
    ...
    RuntimeEra {
        name: "solana-v1.5.19-epochs-148-173-differential-candidate",
    ...
    RuntimeEra {
        name: "solana-v1.6.15-epochs-174-200-differential-candidate",
        start_slot: SOLANA_V1_6_15_CANDIDATE_START_SLOT,
        end_slot_exclusive: Some(SOLANA_V1_6_15_CANDIDATE_END_SLOT_EXCLUSIVE),
        backend: EraBackend::Available(&SOLANA_V1_6_15_RUNTIME),
        admission: AdmissionLevel::Candidate,
    },
    RuntimeEra {
...
pub const fn transaction_status_validation_at(slot: Slot) -> TransactionStatusValidation {
    if slot < OLD_FAITHFUL_STATUS_REQUIRED_START_SLOT {
        ...
        TransactionStatusValidation::RuntimeAuthoritative
    } else {
...
mod tests {
    ...
    fn runtime_registry_is_complete_and_well_formed() {
        ...
        assert_eq!(RUNTIME_DESCRIPTORS.len(), 19);
    ...
    fn descriptor_owns_bootstrap_and_worker_compatibility() {
        ...
        for (backend, revision, environment_override, relative_path) in [
            ...
            (
                RuntimeBackend::SolanaV1_1_15,
                SOLANA_V1_1_15_REVISION,
                "JETSTREAMER_HISTORICAL_WORKER_V1_1_15",
                "../historical-runtime/v1_1_15/target/release/jetstreamer-historical-worker-v1-1-15",
            ),
            (
                RuntimeBackend::SolanaV1_1_23,
            ...
            (
                RuntimeBackend::SolanaV1_2_24Epoch67PreCpi,
                SOLANA_V1_2_24_EPOCH67_PRE_CPI_REVISION,
                "JETSTREAMER_HISTORICAL_WORKER_V1_2_24_EPOCH67_PRE_CPI",
                "../historical-runtime/v1_2_24_epoch67_pre_cpi/target/release/jetstreamer-historical-worker-v1-2-24-epoch67-pre-cpi",
            ),
            (
                RuntimeBackend::SolanaV1_2_32Epoch68Transition,
                SOLANA_V1_2_32_EPOCH68_TRANSITION_REVISION,
                "JETSTREAMER_HISTORICAL_WORKER_V1_2_32_EPOCH68_TRANSITION",
                "../historical-runtime/v1_2_32_epoch68_transition/target/release/jetstreamer-historical-worker-v1-2-32-epoch68-transition",
            ),
            (
                RuntimeBackend::SolanaV1_2_32,
            ...
            (
                RuntimeBackend::SolanaV1_3_23,
                SOLANA_V1_3_23_REVISION,
                "JETSTREAMER_HISTORICAL_WORKER_V1_3_23",
                "../historical-runtime/v1_3_23/target/release/jetstreamer-historical-worker-v1-3-23",
            ),
            (
                RuntimeBackend::SolanaV1_4_25,
            ...
            (
                ...
                "../historical-runtime/v1_5_19/target/release/jetstreamer-historical-worker-v1-5-19",
            ),
            (
                RuntimeBackend::SolanaV1_6_15,
    ...
    fn epochs_12_through_200_route_to_checkpoint_gated_exact_candidates() {
        for (range, backend, descriptor, boundary) in [
            ...
            (
                SOLANA_V1_1_15_CANDIDATE_START_SLOT..SOLANA_V1_1_15_CANDIDATE_END_SLOT_EXCLUSIVE,
                RuntimeBackend::SolanaV1_1_15,
                &SOLANA_V1_1_15_RUNTIME,
                SOLANA_V1_1_15_CANDIDATE_START_SLOT,
            ),
            ...
            (
                SOLANA_V1_2_32_EPOCH68_TRANSITION_END_SLOT_EXCLUSIVE
                    ..SOLANA_V1_2_32_CANDIDATE_END_SLOT_EXCLUSIVE,
                RuntimeBackend::SolanaV1_2_32,
                &SOLANA_V1_2_32_RUNTIME,
                SOLANA_V1_2_32_EPOCH68_TRANSITION_END_SLOT_EXCLUSIVE,
            ),
            ...
            (
                SOLANA_V1_3_23_CANDIDATE_START_SLOT..SOLANA_V1_3_23_CANDIDATE_END_SLOT_EXCLUSIVE,
                RuntimeBackend::SolanaV1_3_23,
                &SOLANA_V1_3_23_RUNTIME,
                SOLANA_V1_3_23_CANDIDATE_START_SLOT,
            ),
