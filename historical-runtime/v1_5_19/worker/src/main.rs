...
const BACKEND_ID: &str = "solana-v1.5.19";
const SOLANA_TAG: &str = "v1.5.19";
const SOLANA_COMMIT: &str = "936ff7424e1306b0df07dabcd6863bf7896d2cb5";
    ...
    for write in writes {
        if write.data.len() as u64 > MAX_PERMITTED_DATA_LENGTH {
            return Err(io::Error::new(
                ...
                "historical account write exceeds v1.5.19's maximum account-data length",
            ));
        }
...
mod tests {
    ...
    fn handshake_is_explicitly_unqualified_candidate() {
        ...
        assert_eq!(handshake.backend_id, "solana-v1.5.19");
        assert_eq!(
            handshake.solana_commit,
            "936ff7424e1306b0df07dabcd6863bf7896d2cb5"
        );
        assert_eq!(
