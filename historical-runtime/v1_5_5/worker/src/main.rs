...
const BACKEND_ID: &str = "solana-v1.5.5";
const SOLANA_TAG: &str = "v1.5.5";
const SOLANA_COMMIT: &str = "10e12d14e105bc2a5cd9c216ffe943a28d2aabf1";
    ...
    for write in writes {
        if write.data.len() as u64 > MAX_PERMITTED_DATA_LENGTH {
            return Err(io::Error::new(
                ...
                "historical account write exceeds v1.5.5's maximum account-data length",
            ));
        }
...
mod tests {
    ...
    fn handshake_is_explicitly_unqualified_candidate() {
        ...
        assert_eq!(handshake.backend_id, "solana-v1.5.5");
        assert_eq!(
            handshake.solana_commit,
            "10e12d14e105bc2a5cd9c216ffe943a28d2aabf1"
        );
        assert_eq!(
